...
import laser_polio.utils as lpu
...
class CompartmentalSEIR:
    ...
    def __init__(self, pars):
        ...
        self.t = 0
        self.dates = lpu.daterange(self.pars["start_date"], days=self.pars.timesteps)
...
if __name__ == "__main__":
    pars = PropertySet(
        dict(  # noqa: C408
            # Time
            start_date=datetime.date.fromisoformat("2025-01-01"),  # Start date of the simulation YYYY-MM-DD
