...
from laser_polio.utils import get_tot_pop_and_cbr, process_sia_schedule
import pandas as pd
import numpy as np
...
pars = PropertySet(dict(
    ...
    beta_spatial    = np.array([0.8, 2., 0.9, 1.5, 0.5]),  # Spatial transmission scalar (multiplied by global rate)
