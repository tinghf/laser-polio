...
study_name = "calib_nigeria_radiation_2y_20250502"
num_trials = 1
parallelism = 4
completions = 24  # The total number of pods (i.e., jobs) that need to successfully complete before the job is considered "done"
namespace = "default"
